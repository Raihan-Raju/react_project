...
const EditDonation = () => {
    ...
    useEffect(() => {
        axios
            .get(
                `http://localhost/react_project/sadaka_php_api/php/donnetions/edit_donnetion.php?id=${id}`
            )
            .then((res) => {
    ...
    const save = () => {
        ...
        axios
            .post(
                "http://localhost/react_project/sadaka_php_api/php/donnetions/update_donations.php",
                formdata,
                {
                    headers: {
