...
const data={amount,fname,email,number,lname,adress,note}
axios.post("http://localhost:5000/donate",data).then((res)=>res?.data?.insertedId && alert("inserted sucess")
)
  }
    return (
        <>
          ...
          <div className="modal-dialog">
            <div className="modal-content">
              ...
              <div className="modal-body">
                <form onSubmit={handlesubmit} className="form-donation">
